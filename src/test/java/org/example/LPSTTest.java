...
public class LPSTTest {
    ...
    @Test
    void test1LPSTSolution() {
        List<Integer> result = new ArrayList<>();
        LPSTSolution solution = new LPSTSolution(rectangles1);
    ...
    @Test
    void test2LPSTSolution() {
        List<Integer> result = new ArrayList<>();
        LPSTSolution solution = new LPSTSolution(rectangles2);
